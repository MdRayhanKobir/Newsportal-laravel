                ...
                <div class="col-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="forms-sample" action="{{ route('store.photogallery') }}" method="POST" enctype="multipart/form-data">
                                @csrf

                                <div class="form-group ">
                                    <label for="exampleInputName1">Photo Title</label>
                                    <input type="text" class="form-control" id="exampleInputName1" name="photo_title">
                                </div>
                                ...
                                <div class="form-group ">
                                    ...
                                    <select class="form-control" id="exampleSelectGender" name="type">
                                        ...
                                        <option value="0">samll Photo</option>
                                    </select>
                                </div>
