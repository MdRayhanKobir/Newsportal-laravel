                ...
                <div class="col-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="forms-sample" action="{{ route('update.posts',['id'=>$post->id]) }}" method="POST" enctype="multipart/form-data">
                                @csrf

                                <div class="row">
                                    <div class="form-group col-md-6">
                                        <label for="exampleInputName1">Title English</label>
                                        <input type="text" class="form-control" id="exampleInputName1" name=" title_eng" value="{{ $post->title_eng }}">
                                    </div>

                                    <div class="form-group col-md-6">
                                        <label for="exampleInputName1">Title Bangla</label>
                                        <input type="text" class="form-control" id="exampleInputName1" name="title_bang" value="{{ $post->title_bang }}">
                                    </div>
                                </div> <!-- End Row  -->
                            ...
                            @enderror
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select class="form-control" name="subcategory_id" id="subcategory_id">
                                            ...
                                            @foreach ($subcategory as $subcategory)
                                                <option value="{{ $subcategory->id }}"<?php
                                                    if($subcategory->id==$post->subcategory_id ){
                                                        echo "selected";
                                                    }
                                                    ?>>{{ $subcategory->subcategory_eng }} |
                                                    {{ $subcategory->subcategory_bang }}</option>
                                            @endforeach
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select class="form-control" name="subdistrict_id" id="subdistrict_id">
                                            ...
                                            @foreach ($subsistrict as $subsistrict)
                                                <option value="{{ $subsistrict->id }}"
                                                    <?php
                                                    if($subsistrict->id==$post->subdistrict_id){
                                                        echo"selected";
                                                    }
                                                         ?>>{{ $subsistrict->subdistrict_eng }} |
                                                    {{ $subsistrict->subdistrict_bang }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div> <!-- End Row  -->
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="exampleInputName1" name="tags_eng" value="{{ $post->tags_eng }}">
                                    </div>

                                    <div class="form-group col-md-6">
                                        <label for="exampleInputName1">Tags Bangla</label>
                                        <input type="text" class="form-control" id="exampleInputName1" name="tags_bang" value="{{ $post->tags_bang }}">
                                    </div>
                                </div> <!-- End Row  -->
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="details_bang" id="summernote1">{{ $post->details_bang }}</textarea>
                                </div>
                                ...
                                <div class="row ml-2">
                                    <label class="form-check-label col-md-3">
                                        <input type="checkbox" name="headline" class="form-check-input" value="1" <?php
                                            if($post->headline){echo"checked";} ?>> Headline
                                        <i class="input-helper"></i></label>

                                    <label class="form-check-label col-md-3">
                                        <input type="checkbox" name="bigthumnail" class="form-check-input" value="1"<?php
                                        if($post->bigthumnail){echo"checked";} ?>>
                                        General Big Thhumbnail <i class="input-helper"></i></label>

                                    <label class="form-check-label col-md-3">
                                        <input type="checkbox" name="first_section" class="form-check-input" value="1"<?php
                                        if($post->first_section){echo"checked";} ?>>
                                        First Section <i class="input-helper"></i></label>

                                    <label class="form-check-label col-md-3">
                                        <input type="checkbox" name="first_section_thumnail" class="form-check-input"
                                            value="1"<?php
                                            if($post->first_section_thumnail){echo"checked";} ?>> First Section BigThumbnail <i class="input-helper"></i></label>
                                </div> <!-- End Row  -->
