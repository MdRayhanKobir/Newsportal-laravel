                    ...
                    <div class="card">
                      <div class="card-body">
                        ...
                        <div class="template-demo">
                            @if ($notice->status==1)
                            <a href="{{ route('deactive.noticesetting',['id'=>$notice->id]) }}">
                                <button type="button" class="btn btn-danger btn-fw " style="float:left">Deactive</button>
                            </a>
                            @else
                            <a href="{{ route('active.noticesetting',['id'=>$notice->id]) }}">
                        ...
                        <form class="forms-sample" action="{{ route('update.noticesetting',['id'=>$notice->id]) }}" method="POST">
                            @csrf
                          ...
                          <button type="submit" class="btn btn-primary mr-2">Update Notice Setting</button>
