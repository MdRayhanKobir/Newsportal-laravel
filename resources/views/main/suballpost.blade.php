    ...
    <div class="row">
        <div class="col-md-4 col-sm-5">
            <div class="archive_img_again">
                <a href="{{ route('singlepost',['id'=>$subcategoryallpost->id]) }}"><img src="{{ asset($subcategoryallpost->image) }}"></a>
            </div>
        </div>
        <div class="col-md-8 col-sm-7">
            <div class="archive_padding_again">
                ...
                <div class="dtails_btn"><a href="{{ route('singlepost',['id'=>$subcategoryallpost->id]) }}">Read More...</a>
                </div>
            </div>
        </div>
    </div>
