...
<div class="content-wrapper">
          ...
          <div class="card-body py-0 px-0 px-sm-3">
            <div class="row align-items-center">
              ...
              <div class="col-5 col-sm-7 col-xl-8 p-0">
                <h4 class="mb-1 mb-sm-0">Welcome to JONOTAR-KOTHA</h4>
    ...
    @php
        ...
        $advertisement=DB::table('adds')->get();
            ...
            <div class="row">
              <div class="col-9">
                <div class="d-flex align-items-center align-self-start">
                  ...
                  <p class="text-success ml-2 mb-0 font-weight-medium">District</p>
                </div>
              </div>
              <div class="col-3">
                <div class="icon icon-box-success">
        ...
        <div class="card">
          <div class="card-body">
            <div class="row">
              <div class="col-9">
                <div class="d-flex align-items-center align-self-start">
                  <h3 class="mb-0">{{ Count($advertisement) }}</h3>
                  <p class="text-success ml-2 mb-0 font-weight-medium">Advertisement</p>
                </div>
              </div>
              <div class="col-3">
                <div class="icon icon-box-success ">
